...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gret-800'>
      ...
      <p className='mb-8 max-w-md'>Let's start with a quick product ans we will have you up ans running in no time!</p>
